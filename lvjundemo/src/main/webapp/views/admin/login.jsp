...
<div class="layui-container">
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form" action="${pageContext.request.contextPath}/checkLoginadmin" method="POST">
                <div class="layui-form-item logo-title">
                    <h1>管理员后台登录</h1>
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-username" for="adminname"></label>
                    <input type="text" name="adminname" lay-verify="required|account" placeholder="用户名" autocomplete="off" class="layui-input" value="">
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-password" for="adminpassword" ></label>
                    <input type="password" name="adminpassword" lay-verify="required|password" placeholder="密码" autocomplete="off" class="layui-input" value="">
                </div>
                <%--                <div class="layui-form-item">--%>
                ...
                <%--                </div>--%>
                <div class="layui-form-item">
                    <input type="checkbox"  checked="checked" name="rememberMe" value="true" lay-skin="primary" title="记住密码">
                </div>
                <div class="layui-form-item">
