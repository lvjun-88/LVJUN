...
<%--                <div class="sidebar-toggle"><i class="fa fa-bars"></i></div>--%>
                <div class="sidenav" id="sidebar-nav">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active"> <a href="${pageContext.request.contextPath}/getmyuser"><i class="layui-icon layui-icon-rate"></i> 会员中心</a> </li>
                ...
                <div class="panel panel-default ">
                    <div class="panel-body">
                        <h2 class="page-header">
                            会员中心
                            <a href="${pageContext.request.contextPath}/getmyuserinfo" class="btn btn-success pull-right">
                        ...
                        <div class="row user-baseinfo">
                            <div class="col-md-3 col-sm-3 col-xs-2 text-center user-center">
                                <a href="" title="">
                                    <span class="avatar-img"><img src="${pageContext.request.contextPath}/images/img/${sessionScope.users.uicon}" alt=""></span>
                                </a>
                            </div>
                            <div class="col-md-9 col-sm-9 col-xs-10">
                                ...
                                <div class="ui-content">
                                    <!-- Heading -->
                                    <h4><a href="">${sessionScope.users.uname}</a></h4>
                                    <!-- Paragraph -->
                                    <p>
                                        <a href="">
                                            ${sessionScope.users.usignature}                                    </a>
                                    </p>
                                    <!-- Success -->
                                    <div class="basicinfo">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8 col-md-4">
                                                <a href="javascript:;" class="viewmoney">${sessionScope.users.uemail}</a>
                                            </div>
                                            <div class="col-xs-4 col-md-2">手机号</div>
                                            <div class="col-xs-8 col-md-4">
                                                <a href="javascript:;" class="viewscore">${sessionScope.users.uphoneid}</a>
                                            </div>
                                        </div>
<%--                                        <div class="row">--%>
...
<%--                                        </div>--%>
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8 col-md-4">${sessionScope.users.utime}</div>
