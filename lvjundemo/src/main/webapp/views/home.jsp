...
<div class="container" id="content-container" style="height: auto !important;">
    ...
    <div class="row" style="height: auto !important;">
		...
		<div class="layui-carousel" id="test10">
		  <div carousel-item="">
			<a href="${web.webimageurl1}" target="_blank">
				<div><img style="height:350px;width:100%" src="${pageContext.request.contextPath}/images/adminimg/${web.webimage1}"></div>
		    <div class="carousel-caption hidden-xs">
                    <h3>${web.webimagename1}</h3>
                </div>
			</a>

			<a href="${web.webimageurl2}" target="_blank">
                <div><img style="height:350px;width:100%" src="${pageContext.request.contextPath}/images/adminimg/${web.webimage2}"></div>
		    <div class="carousel-caption hidden-xs">
                <h3>${web.webimagename2}</h3>
                </div>
			</a>

              <a href="${web.webimageurl3}" target="_blank">
                  <div><img style="height:350px;width:100%" src="${pageContext.request.contextPath}/images/adminimg/${web.webimage3}"></div>
                  <div class="carousel-caption hidden-xs">
                      <h3>${web.webimagename3}</h3>
                  </div>
              </a>
		  </div>
		</div>
            ...
            layui.use('flow', function(){
                ...
                flow.load({
                    ...
                    ,done: function(page, next){ //到达临界点（默认滚动触发），触发下一页
                        ...
                        $.get('getarticleslistjson?page='+page+'&limit=5', function(res){
                            //假设你的列表返回在data集合中
                            layui.each(res.data, function(index, item){
                                lis.push('<article class="article-item">\n' +
                                    ...
                                    '                                                <!--                                         文章标题-->\n' +
                                    '                                            <a href="articleinfo?aid='+item.aid+'" title="'+item.aname+'">'+item.aname+'</a>\n' +
                                    '                                        </h3>\n' +
                                    '                                            <!--                                          文章简介-->\n' +
                                    ...
                                    '                                                <!--                                          评论次数-->\n' +
                                    '                                            <span itemprop="comments"><a  title="评论数"><i class="layui-icon layui-icon-dialogue"></i></a> '+item.acommentcounts+' 评论</span>\n' +
                                    '                                                <!--                                          浏览次数-->\n' +
        ...
        <main class="col-md-8 layui-hide-md">
            ...
            <div class="layui-carousel" id="test11">
                <div carousel-item="">
                    <a href="/${web.webimageurl1}" target="_blank">
                        <div><img style="height:100%;width:100%" src="${pageContext.request.contextPath}/images/adminimg/${web.webimage1}"></div>
                        <div class="carousel-caption hidden-xs">
                            <h3>${web.webimagename1}</h3>
                        </div>
                    </a>
                    ...
                    <a href="/${web.webimageurl2}" target="_blank">
                        <div><img  style="height:100%;width:100%" src="${pageContext.request.contextPath}/images/adminimg/${web.webimage2}"></div>
                        <div class="carousel-caption hidden-xs">
                            <h3>${web.webimagename2}</h3>
                        </div>
                    </a>
                    ...
                    <a href="/${web.webimageurl3}" target="_blank">
                        <div><img style="height:100%;width:100%" src="${pageContext.request.contextPath}/images/adminimg/${web.webimage3}"></div>
                        <div class="carousel-caption hidden-xs">
                            <h3>${web.webimagename3}</h3>
                        </div>
                    </a>
                        ...
                        $.get('getarticleslistjson?page='+page+'&limit=5', function(res){
                            ...
                            layui.each(res.data, function(index, item){
                                lis.push('<article class="article-item">\n' +
                                    ...
                                    '                                            <span itemprop="likes" title="点赞次数"><i class="layui-icon layui-icon-praise"></i> '+item.alike+' 点赞</span>\n' +
                                    '                                                <!--                                          评论次数-->\n' +
                                    '                                            <span itemprop="comments"><a h  title="评论数"><i class="layui-icon layui-icon-dialogue"></i> 0</a>'+item.acommentcounts+' 评论</span>\n' +
                                    '                                                <!--                                          浏览次数-->\n' +
                                    '                                            <span itemprop="views" title="浏览次数"><i class="layui-icon layui-icon-fire"></i> '+item.alooks+' 浏览</span>\n' +
                                    '                                        </div>\n' +
                                    '                                    </div>\n' +
    ...
    <!-- S 浮动按钮 -->
        ...
        <a href="javascript:;">
            ...
            <div class="floatbtn-wrapper">
                <div class="qrcode"><img src="${pageContext.request.contextPath}/images/adminimg/${web.webtwo}"></div>
                <p>微信扫一扫</p>
                <p>微信扫一扫体验</p>
            </div>
        </a>
...
<script type="text/javascript">
    (function(){document.write(unescape('%3Cdiv id="bdcs"%3E%3C/div%3E'));
        ...
        bdcs.src = 'http://znsv.baidu.com/customer_search/api/js?sid=9640136321628561987' + '&plate_url=' + encodeURIComponent(window.location.href) + '&t=' + Math.ceil(new Date()/3600000);
        var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(bdcs, s);})();</script><div id="bdcs"></div>
...
<ins class="adsbygoogle adsbygoogle-noablate" data-adsbygoogle-status="done" style="display: none !important;">
    <ins id="aswift_0_expand" style="display:inline-table;border:none;height:0px;margin:0;padding:0;position:relative;visibility:visible;width:0px;background-color:transparent;" tabindex="0" title="Advertisement" aria-label="Advertisement">
        <ins id="aswift_0_anchor" style="display:block;border:none;height:0px;margin:0;padding:0;position:relative;visibility:visible;width:0px;background-color:transparent;"><iframe id="aswift_0" name="aswift_0" style="left:0;position:absolute;top:0;border:0;width:undefinedpx;height:undefinedpx;" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" frameborder="0" src="${pageContext.request.contextPath}/home/ads(1).html" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allowfullscreen="true" data-google-container-id="a!1" data-load-complete="true"></iframe></ins></ins></ins>
<iframe id="google_osd_static_frame_8919559546222" name="google_osd_static_frame" style="display: none; width: 0px; height: 0px;" src="${pageContext.request.contextPath}/home/saved_resource.html"></iframe></body><iframe id="google_esf" name="google_esf" src="${pageContext.request.contextPath}/home/zrt_lookup.html" data-ad-client="ca-pub-2619064356659560" style="display: none;"></iframe></html>