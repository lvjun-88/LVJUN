            ...
            <div class="col-md-3 layui-hide-xs">
                <div class="sidenav" id="sidebar-nav">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active"> <a href="${pageContext.request.contextPath}/updatemypassweb"><i class="layui-icon layui-icon-set-sm"></i> 修改密码</a> </li>
                    </ul>
                    <ul class="list-group">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form name="form" id="layui-form" class="layui-form" method="POST" action="${pageContext.request.contextPath}/updatemypass"  novalidate="novalidate">


                            <div class="layui-form-item">
                                <label class="layui-form-label" for="upass">新密码</label>
                                <div class="layui-input-block">
                                    <input class="layui-input" id="upass"  type="text" name="upass" value="" lay-verify="pass" placeholder="请填写6到12位密码" autocomplete="off">
                            ...
                            <div class="layui-form-item">
                                <div class="layui-input-block">
                                    <button type="submit" class="layui-btn" lay-submit="" lay-filter="demo1">提 交</button>
