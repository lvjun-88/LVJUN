            ...
            <div class="col-md-3 layui-hide-xs" >
                ...
                <div class="sidenav" id="sidebar-nav">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active"><a href="${pageContext.request.contextPath}/gowriteregister"><i class="layui-icon layui-icon-edit"></i> 发布文章</a></li>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form name="form" id="layui-form" class="layui-form" method="POST" action="${pageContext.request.contextPath}/addpublisharticle"  novalidate="novalidate">
...
<%--                                            <input type="hidden" name="businessusewebid"   value="${businessuseweb.businessusewebid}" class="layui-input">--%>
                                            <input type="hidden" name="aimg" class="image" value="">
<%--                                            <img src="${pageContext.request.contextPath}/images/imags/${businessuseweb.businessusewebimage}" style="width: 200px;height: 150px">--%>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input class="layui-input" id="aname"  type="text" name="aname" value="" lay-verify="title" placeholder="" autocomplete="off">
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <select id="atid" class="" lay-verify="required" reqtext="文章类型是必填项，岂能为空？" name="atid" >
                                                ...
                                                <c:forEach items="${atype}" var="atype">
                                                    <option value="${atype.atid}">${atype.atype}</option>
                                                </c:forEach>
                                    ...
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <input class="layui-input" id="ainfo"  type="text" name="ainfo" value="" lay-verify="required" lay-reqtext="文章内容是必填项，岂能为空？" placeholder="" autocomplete="off">
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <textarea id="LAY_demo_editor" name="article" class="layui-textarea layui-hide" lay-verify="content"   placeholder="请输入内容" class="layui-textarea"></textarea>
                                            <div class="help-block"></div>
                                        </div>
                                    </div>
