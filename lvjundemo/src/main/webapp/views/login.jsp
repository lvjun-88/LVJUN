...
<main class="content">
    <div id="content-container" class="container">
        <div class="user-section login-section">
            <div class="logon-tab clearfix"> <a class="active">登 录</a> <a href="${pageContext.request.contextPath}/register">注 册</a> </div>
            <div class="login-main">



                <form name="form" id="layui-form" class="layui-form" method="POST" action="${pageContext.request.contextPath}/login"  novalidate="novalidate">
...
<%--                    <input type="hidden" name="__token__" value="d446a0ff98c8ea54cb708e04da1b1a76">--%>
                    ...
                    <div class="layui-input-block">
                        <input class="layui-input" id="uname"  type="text" name="uname" value="" lay-verify="title" placeholder="邮箱/手机/用户名" autocomplete="off">
                        <div class="help-block"></div>
                    </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label" for="upass">密码</label>
                        <div class="layui-input-block">
                            <input class="layui-input" id="upass"  type="password" name="upass" value="" lay-verify="pass" placeholder="密码" autocomplete="off">
...
<%--                        <div class="controls">--%>
<%--                            <input class="form-control input-lg" id="upass" type="password" name="upass" placeholder="密码" autocomplete="off">--%>
<%--                        </div>--%>
<%--                    </div>--%>

                    <div class="form-group">
                        <div class="controls">
                            <input type="checkbox" lay-skin="primary" name="keeplogin" checked="checked" value="1">保持会话
