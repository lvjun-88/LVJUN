                ...
                <div class="panel panel-default ">
                    <div class="panel-body">
                        <h2 class="page-header">
                            我的信息
                            <a href="${pageContext.request.contextPath}/goaddmychats" class="btn btn-success pull-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="layui-card-body">
                                    <h4 id="layerDemo">
                                        留言人: <a data-method="setTop" class="layui-btn"  style="background: #ffffff;" ><p style="color: black;"> ${cs.name}</p></a>
                                        <a href="${pageContext.request.contextPath}/deletemychats?cid=${cs.cid}" class="pull-right">删除留言<i class="layui-icon layui-icon-delete"></i> </a>
                                    </h4>
                                </div>
                                <div class="layui-card-body">
                                    <p class="comment-content">留言信息: ${cs.fsinfo}</p>
                                    <p class="text-muted">留言于 ${cs.fstime}</p>
                                ...
                                var active = {
                                    setTop: function(){
                                        ...
                                        layer.open({
                                            ...
                                            ,maxmin: true
                                            ,offset: 'auto'
                                            ,content: '${pageContext.request.contextPath}/getuseroneinfo?uid=${cs.fsid}'
                                            ,id:1
                                            ,anim:1
