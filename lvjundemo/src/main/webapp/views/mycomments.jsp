            ...
            <div class="col-md-3 layui-hide-xs" >
                ...
                <div class="sidenav" id="sidebar-nav">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active"><a href="${pageContext.request.contextPath}/getmycomments"><i class="layui-icon layui-icon-dialogue"></i> 我发表的评论</a></li>
                    </ul>
                </div>
        ...
        <div class="panel panel-default panel-user">
            <div class="panel-body">
                <div class="panel-post">
                    <h2 class="page-header">我发表的评论</h2>
                </div>
                <c:forEach items="${list}" var="mycomments">

                <div class="row">
                    <div class="col-md-3 text-center">
                        <a href="${pageContext.request.contextPath}/userarticleinfo?aid=${mycomments.aid}"  class="img-thumb">
                            <div class="embed-responsive embed-responsive-4by3 img-zoom">
<%--                                <img src="https://www.jikeyuan.cn/uploads/20190711/3cb77537cd314477c086fb90b4c9f849.png" onerror="this.src='/assets/addons/cms/img/noimage.jpg';this.onerror=null;">--%>
                                <img src="${pageContext.request.contextPath}/images/img/${mycomments.aimg}"  class="embed-responsive-item">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-9">
                        <h4>
                            <a href="${pageContext.request.contextPath}/userarticleinfo?aid=${mycomments.aid}">${mycomments.aname}</a>
                        </h4>
                        <p class="comment-content">${mycomments.comment}</p>
                        <p class="text-muted">发表于 ${mycomments.actime}</p>
                        <a href="${pageContext.request.contextPath}/deletemycomments?acid=${mycomments.acid}" class="text-muted">删除评论<i class="layui-icon layui-icon-delete"></i> </a>
                    </div>
                </div>
                <hr>
                </c:forEach>
